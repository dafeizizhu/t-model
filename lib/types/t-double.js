...
class TDouble extends TBase {
  ...
  static readFrom (is, tBuffer) {
    return new this(tBuffer.readDouble()).valueOf()
  }
  ...
  writeTo (os, tBuffer) {
    tBuffer.writeDouble(this._value)
  }
  valueOf () {
    return this._value === 0 ? 0 : this._value.toPrecision(this.constructor.PRECISION)
  }
}

module.exports = TDouble
